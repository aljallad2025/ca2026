...
@Component({
  ...
  standalone: true,
  imports: [IonContent, IonInput, IonButton, IonIcon, IonSegment, IonSegmentButton, IonLabel, IonSpinner, FormsModule, CommonModule, TranslatePipe],
})
export class LoginPage {
  ...
  constructor(private auth: AuthService, private router: Router, private toast: ToastController, public lang: LanguageService) {
