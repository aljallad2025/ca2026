...
@Component({
  ...
  standalone: true,
  imports: [IonContent, IonInput, IonButton, IonIcon, IonSpinner, IonHeader, IonToolbar, IonTitle, IonBackButton, IonButtons, FormsModule, CommonModule, TranslatePipe],
})
