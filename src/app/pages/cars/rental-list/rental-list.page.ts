...
@Component({
  ...
  standalone: true,
  imports: [IonContent, IonHeader, IonToolbar, IonTitle, IonSearchbar, IonIcon, IonButton, IonSegment, IonSegmentButton, IonLabel, IonSkeletonText, IonRefresher, IonRefresherContent, FormsModule, CommonModule, TranslatePipe],
})
